  ...
  return (
    <div className="p-6 prose prose-gray dark:prose-invert max-w-none">
      ...
      <p className="text-lg text-muted-foreground mb-8">
        Integrate DocMate's intelligent document processing directly into your applications and workflows using our straightforward REST API. Automate data extraction programmatically based on your pre-configured endpoints and templates.
      </p>
      ...
      <p className="text-muted-foreground mb-4">
        You can create, manage, and configure your API endpoints and keys entirely within the DocMate application:
      </p>
      <ol className="list-decimal pl-6 space-y-2 text-muted-foreground mb-6">
        <li>Log in to your DocMate account.</li>
...
# 2. Make the API call
curl -X POST https://docmate-beta.vercel.app/api/analyze/YOUR_ENDPOINT_ID \\\
...
api_endpoint = "https://docmate-beta.vercel.app/api/analyze/YOUR_ENDPOINT_ID" # Replace with your full endpoint URL
