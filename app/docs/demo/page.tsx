  ...
  return (
    <div className="p-6 prose prose-gray dark:prose-invert max-w-none">
      ...
      <p className="text-lg text-muted-foreground mb-8">
        Want a quick taste of DociMate without signing up? The interactive demo on our <Link href="/demo" className="text-primary hover:underline">Demo page</Link> allows you to upload specific document types and see the extraction results instantly. It's a great way to understand the basic workflow.
      </p>
      ...
      <p className="text-muted-foreground mb-4">
        Scroll down the Demo page until you find the section titled "Try DociMate Now" or similar. This is the interactive demo component.
      </p>
      <CodePlaceholder 
      ...
      <p className="text-muted-foreground mb-4">
        Click the 'Process Document' (or similarly named) button. DociMate will analyze the file based on the selected document type's predefined template.
      </p>

      <h3 className="text-xl font-semibold mt-6 mb-3">Step 6: View the Extracted Results</h3>
      <p className="text-muted-foreground mb-4">
        After a few moments, a results dialog will pop up. Here, you can see the information DociMate extracted from your document.
      </p>
      <p className="text-muted-foreground mb-4">
      ...
      <p className="text-muted-foreground mb-4">
        Liked what you saw? To unlock the full potential of DociMate, including creating your own custom templates, saving documents, and using the API, you'll need to <Link href="/signup" className="text-primary hover:underline">sign up for an account</Link>.
      </p>
