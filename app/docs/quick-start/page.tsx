  ...
  return (
    <div className="p-6 prose prose-gray dark:prose-invert max-w-none">
      ...
      <p className="text-lg text-muted-foreground mb-8">
        Ready to see DociMate in action? This guide will get you up and running in minutes. We'll cover signing up and taking the Playground for a spin.
      </p>

      <h2 className="text-2xl font-semibold mt-10 mb-4">1. Signing Up</h2>
      <p className="text-muted-foreground mb-4">
        First things first, you'll need an account to access the full power of DociMate, including saving templates and managing your documents.
      </p>
      <ul className="list-decimal pl-6 space-y-2 text-muted-foreground mb-6">
        ...
        <li>Log in to your shiny new DociMate account!</li>
      </ul>
      ...
      <p className="text-muted-foreground mb-6">
        The Playground is where the magic happens without needing any complex setup. It's perfect for testing templates and seeing how DociMate extracts data from your documents.
      </p>
      ...
      <p className="text-muted-foreground mb-4">
        Templates tell DociMate what information to look for. You can:
      </p>
      ...
      <p className="text-muted-foreground mb-4">
        Hit the 'Process' button. DociMate's AI will analyze the document based on your chosen template.
      </p>
      ...
      <p className="text-muted-foreground mb-4">
        Want to automate this process in your own applications? You can use the DociMate API.
      </p>
      <p className="text-muted-foreground mb-4">
      ...
      <p className="text-lg text-muted-foreground mt-10">
        That's it! You've successfully signed up and processed your first document using the DociMate Playground. Explore further, experiment with different documents and templates, and check out the rest of the documentation for more advanced features.
      </p>
    </div>
  );
} 