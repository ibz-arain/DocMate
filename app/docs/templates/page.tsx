  ...
  return (
    <div className="p-6 prose prose-gray dark:prose-invert max-w-none">
      ...
      <p className="text-lg text-muted-foreground mb-8">
        Templates are the heart of DociMate's targeted extraction. They act as a blueprint, telling our AI exactly what information you want to pull from your documents and how that information is structured. Master templates, and you master automated data extraction.
      </p>

      <h2 className="text-2xl font-semibold mt-10 mb-4">What is a Template?</h2>
      <p className="text-muted-foreground mb-6">
        Think of a template as a structured shopping list for data. Instead of manually scanning a document for every piece of information, you define the items (fields) you need in a template. DociMate then uses this list to find and extract only those specific items from the document you upload.
      </p>
      <p className="text-muted-foreground mb-6">
      ...
      <p className="text-muted-foreground mb-4">
        In your template, you'd create a section (e.g., "Header Info") of type `data` and add fields for each specific item you want (e.g., Field Name: `InvoiceNumber`, Type: `string`). DociMate will look for these labels or values individually in the document.
      </p>
      ...
      <p className="text-muted-foreground mb-4">
        You'd create a section (e.g., "Line Items") of type `table` and define the columns as fields (e.g., Field Name: `ItemName`, Type: `string`; Field Name: `Quantity`, Type: `number`). DociMate will identify the tabular structure in the document and extract the data row by row based on your defined columns.
      </p>
      ...
      <ul className="list-disc pl-6 space-y-2 text-muted-foreground mb-6">
        ...
        <li><strong>Type:</strong> The expected data type. Common types include:
          <ul className="list-circle pl-6 mt-1">
            ...
            <li>`date`: Dates (DociMate tries to standardize formats)</li>
      ...
      <p className="text-muted-foreground mb-4">
        When processing a document in the <Link href="/playground" className="text-primary hover:underline">Playground</Link>, simply select your saved template from the dropdown menu before hitting 'Process'. DociMate will then use that specific structure for extraction.
      </p>
      <TemplatePlaceholder 
      ...
      <p className="text-lg text-muted-foreground mt-10">
        By creating well-designed templates, you unlock DociMate's ability to precisely and automatically extract the information you need, saving you time and effort.
      </p>
    </div>
  );
} 